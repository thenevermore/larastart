...
This is Starter Admin For Laravel. <br>
This repo is based on practical web application development course on youtube.<br>
Link for this complete course is https://www.youtube.com/playlist?list=PLB4AdipoHpxaHDLIaMdtro1eXnQtl_UvE

Here are the things you will learn in this Course and what the repo include out of the box:<br>
